...
> _They call us villains. We call ourselves strategists._
...
[⬇️ Download Source Code](https://chat.z.ai/c/98fa29b1-bcd7-4e4b-9b70-b88e9f691069#quick-start) • [🎮 How to Play](https://chat.z.ai/c/98fa29b1-bcd7-4e4b-9b70-b88e9f691069#how-to-play) • [🛠️ Tech Stack](https://chat.z.ai/c/98fa29b1-bcd7-4e4b-9b70-b88e9f691069#tech-stack)
...
*   **Pinterest-Level Design:** Dark theme, glassmorphism, grain overlays, and elegant typography.
...
3.  **Sign Up** (data is saved locally to your browser) and hit **RULE**.
...
ControlAction**Click / Tap**Spawn selected minion on the path.**Drag**Spawn multiple minions rapidly.**Spell Buttons**Tap to activate, then tap the battlefield to target (Meteor).**Space / Esc**Pause the game.
...
> _Add screenshots of your game here to make it pop!_
...
This project is open source and available under the [MIT License](https://chat.z.ai/c/LICENSE).

**⚔️ Protect the Throne. Rule the Darkness. ⚔️**

Made with ❤️ and ☕ by [Soumil Mittal](https://github.com/SoumilMittal)
...
_VThe Darkness Awaits Your Command._
